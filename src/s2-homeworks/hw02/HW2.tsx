...
export const filterAffairs = (affairs: Array<AffairType>, filter: FilterType): Array<AffairType> => affairs.filter(affair => filter !== 'all' ? affair.priority === filter : affair)
export const deleteAffair = (affairs: Array<AffairType>, _id: number): Array<AffairType> => affairs.filter(affair => affair._id !== _id)
